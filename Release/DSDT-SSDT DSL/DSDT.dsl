 ...
 * 
 * Disassembly of DSDT.aml, Fri Jan  1 14:23:22 2016
 *
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000014)
{
     ...
     * disassembly, but only 0 was resolved (11 unresolved). Additional
    ...
    External (_SB_.PCI0.PEGP.GFX0.EPON, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    ...
    External (_SB_.PCI0.PEGP.GFX0.LCD_, UnknownObj)
    External (_SB_.PCI0.PEGP.GFX0.MLTF, FieldUnitObj)
...
P8XH (One, 0xAB)
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            If (LGreaterEqual (OSYS, 0x07D9))
            {
                If (LEqual (VVID, 0x10DE))
                {
                    If (LEqual (NHDA, One))
                    {
                        Store (One, \_SB.PCI0.PEGP.GFX0.MLTF)
                    }
                    Else
                    {
                        Store (Zero, \_SB.PCI0.PEGP.GFX0.MLTF)
                    }
                }
            }
    ...
    {
        \_SB.PCI0.PEGP.GFX0.EVD2 (Arg0, Arg1)
    }

    Method (EV5, 2, NotSerialized)
    {
        \_SB.PCI0.IGPU.BRT6 (Arg0, Arg1)
        \_SB.PCI0.PEGP.GFX0.BRT6 (Arg0, Arg1)
    }
    ...
    Method (EV7, 2, NotSerialized)
    {
        ...
        \_SB.PCI0.PEGP.GFX0.EVD1 (Arg0, Arg1)
    }
    ...
    Method (EV3, 2, NotSerialized)
    {
        ...
        \_SB.PCI0.PEGP.GFX0.DINI (Arg0, Arg1)
        \_SB.PCI0.PEGP.GFX0.VINI (Arg0, Arg1)
        \_SB.SOS0 (Arg0, Arg1)
    }
    ...
    {
        \_SB.PCI0.PEGP.GFX0.EVD6 (Arg0, Arg1)
    }
    ...
    Method (EV6, 2, NotSerialized)
    {
        ...
        \_SB.PCI0.PEGP.GFX0.EVD3 (Arg0, Arg1)
    }
