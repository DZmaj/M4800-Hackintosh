 ...
 * 
 * Disassembly of SSDT-8.aml, Fri Jan  1 14:23:22 2016
 *
 ...
 */
DefinitionBlock ("SSDT-8.aml", "SSDT", 1, "NvdRef", "NvdTabl", 0x00001000)
{
    /*
     ...
     * required for each:
     */
    External (_SB_.PCI0.PEG0.PEGP.AFN7, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GOBT, 1, Serialized)
        {
            ...
            If (LEqual (USRG, 0x564B))
            {
                While (One)
                {
                    ...
                    Else
                    {
                        If (LEqual (_T_0, 0x0E3B))
                        {
                            Return (KEQ3)
                        }
                        Else
                        {
                            If (LEqual (_T_0, 0x0E3A))
                            {
                                Return (KEQ1)
                            }
                            Else
                            {
                                If (LEqual (_T_0, 0x0DDA))
                                {
                                    Return (KPQ3)
                                }
                                Else
                                {
                                    If (LEqual (_T_0, 0x0DFA))
                                    {
                                        Return (KPQ1)
                                    }
                                }
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
                                        ...
                                        If (LEqual (LMOD, 0x01))
                                        {
                                            ...
                                            If (LOr (LEqual (SVID, 0x053E1028), LEqual (SVID, 0x053F1028)))
                                            {
                                                While (One)
                                                {
                                                    ...
                                                    Else
                                                    {
                                                        If (LEqual (_T_1, 0x11BD))
                                                        {
                                                            Return (L3D1)
                                                        }
                                                        Else
                                                        {
                                                            If (LEqual (_T_1, 0x11BE))
                                                            {
                                                                Return (L3D2)
                                                            }
                                                            Else
            ...
            If (LEqual (UCMP (Arg0, ToUUID ("4004a400-917d-4cf2-b89c-79b62fd55665")), One))
            {
                While (One)
                {
                    Store (Arg2, _T_2)
