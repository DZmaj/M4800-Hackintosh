/*
 * Intel ACPI Comp0x01nt Architecture
 * AML Disassembler version 20140926-64 [Oct 16 2014]
 * Copyright (c) 2000 - 2014 Intel Corporation
 * 
 * Disassembly of SSDT-8.aml, Fri Jan  1 12:48:14 2016
 *
...
DefinitionBlock ("SSDT6.aml", "SSDT", 1, "NvdRef", "NvdTabl", 0x00001000)
{
    /*
    ...
    External (_SB_.PCI0.PEGP.GFX0, DeviceObj)
    External (_SB_.PCI0.PEGP.GFX0.HPEV, IntObj)
    External (_SB_.PCI0.PEGP.GFX0.NOPE, IntObj)
    External (_SB_.PCI0.PEGP.GFX0.VDID, FieldUnitObj)
    External (_SB_.PCI0.PEGP.GFX0.VDP8, BuffFieldObj)
    ...
    External (_SB_.PCI0.PEGP.GFX0.AFN7, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    ...
    Scope (\_SB.PCI0.PEGP.GFX0)
    {
        ...
        {
            Name (T_0, 0x00)  // _T_x: Emitted by ASL Compiler
            ...
            If (LEqual (USRG, 0x564B))
            {
                ...
                {
                    Store (VDID, T_0)
                    If (LEqual (T_0, 0x109A))
                    {
                        Return (KEQ5)
                    }
                    Else
                    {
                        If (LEqual (T_0, 0x0E3B))
                        {
                            Return (KEQ3)
                        }
                        Else
                        {
                            If (LEqual (T_0, 0x0E3A))
                            {
                                Return (KEQ1)
                            }
                            Else
                            {
                                If (LEqual (T_0, 0x0DDA))
                                {
                                    Return (KPQ3)
                                }
                                Else
                                {
                                    If (LEqual (T_0, 0x0DFA))
                                    {
                                        Return (KPQ1)
                                    }
                                }
                ...
                Else
                {
                    ...
                    Else
                    {
                        ...
                        Else
                        {
                            If (LEqual (T_0, 0x10))
                            {
                                Return (\_SB.PCI0.PEGP.GFX0.GOBT (Arg3))
                            }
                        }
                    }
                }
        ...
        {
            If (LEqual (\_SB.PCI0.PEGP.GFX0.OMPR, 0x03))
            {
                _OFF ()
                Store (0x01, DGOS)
                Store (0x02, \_SB.PCI0.PEGP.GFX0.OMPR)
            }
        }
        ...
        Method (CSCF, 0, NotSerialized)
        {
            ...
            Else
            {
                If (LAnd (LEqual (IDMN, 0xE430), LEqual (IDPC, 0x0310)))
                {
                    Return (0x01)
                }
                Else
        ...
        {
            Name (T_2, 0x00)  // _T_x: Emitted by ASL Compiler
            Name (T_1, 0x00)  // _T_x: Emitted by ASL Compiler
            Name (T_0, 0x00)  // _T_x: Emitted by ASL Compiler
            If (LEqual (UCMP (Arg0, ToUUID ("d4a50b75-65c7-46f7-bfb7-41514cea0244")), 0x01))
            {
                                    ...
                                    If (LEqual (T_0, 0x16))
                                    {
                                        ...
                                        If (LEqual (LMOD, 0x01))
                                        {
                                            ...
                                            If (LOr (LEqual (SVID, 0x053E1028), LEqual (SVID, 0x053F1028)))
                                            {
                                                ...
                                                {
                                                    Store (Local0, T_1)
                                                    If (LEqual (T_1, 0x11BC))
                                                    {
                                                        Return (L3D0)
                                                    }
                                                    Else
                                                    {
                                                        If (LEqual (T_1, 0x11BD))
                                                        {
                                                            Return (L3D1)
                                                        }
                                                        Else
                                                        {
                                                            If (LEqual (T_1, 0x11BE))
                                                            {
                                                                Return (L3D2)
                                                            }
                                                            Else
            ...
            If (LEqual (UCMP (Arg0, ToUUID ("4004a400-917d-4cf2-b89c-79b62fd55665")), 0x01))
            {
                While (0x01)
                {
                    Store (Arg2, T_2)
            ...
            Else
            {
                If (CMPB (Arg0, ToUUID ("a486d8f8-0bda-471b-a72b-6042a6b5bee0")))
                {
                    ...
                    Return (\_SB.PCI0.PEGP.GFX0.NVOP (Arg0, Arg1, Arg2, Arg3))
                }
            }
